...
public class Pager implements QueryStringBindable<Pager> {
    ...
    public static final Pager DEFAULT_PAGER = new Pager(FIRST_PAGE, DEFAULT_PAGE_SIZE);
    ...
    public F.Option<Pager> bind(String key, Map<String, String[]> params) {
        String _page = params.containsKey(PAGE_PARAM) ? params.get(PAGE_PARAM)[0] : String.valueOf(FIRST_PAGE);
