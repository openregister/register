...
public class Application extends Controller {
    ...
    static {
        ...
        if (uri.startsWith("mongodb")) store = new MongodbStore(uri, name, Register.keys);
        else if (uri.startsWith("postgres")) store = new PostgresqlStore(uri, name, Register.keys);
    ...
    public static F.Promise<Result> findByKey(String key, String value) {
        ...
        return recordF.map(record -> Representations.toRecord(request(), Register.keys, record));
    }
    ...
    public static F.Promise<Result> search() {
        ...
        return recordsF.map(records -> Representations.toListOfRecords(request(), Register.keys, records));
    }
