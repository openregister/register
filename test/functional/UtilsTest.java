...
public class UtilsTest extends ApplicationTests {
    ...
    public static final Field FIELD_WITH_REGISTER = new Field("fields", "Field", new Datatype("list"), Cardinality.ONE, Optional.of("field"));
    ...
    public void testRenderALinkToADatatype() throws Exception {
        ...
        assertThat(Utils.toLink(new Datatype("string")).text()).isEqualTo("<a class=\"link_to_register\" href=\"http://localhost:8888/datatype/string\">string</a>");
    }
